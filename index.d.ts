...
export type ReturnFetchDefaultOptions = {
    ...
    interceptors?: {
         ...
         * @public
         */
        request?: (requestArgs: FetchArgs) => Promise<FetchArgs>;
        /**
         ...
         * @public
         */
        response?: (response: Response, requestArgs: FetchArgs) => Promise<Response>;
    };
};
declare const returnFetch: (defaultOptions?: ReturnFetchDefaultOptions) => {
    setDefaultHeaders: (headers: HeadersInit | undefined) => void;
    invoke: (input: URL | RequestInfo, init?: RequestInit | undefined) => Promise<Response>;
};
